...
import { useNavigate, Link } from 'react-router-dom';// Helps move between different pages
import API from '../api/axios';//Sends the registration data to the server
import { Eye, EyeOff, XCircle, CheckCircle, Building2 } from 'lucide-react';
import './Pages.css';
...
function AdminRegister() {
    ...
    const validateForm = () => {
        ...
        // all error handling for admin registeration 
        ...
        <div className="auth-container">
            <div className="auth-box">
                ...
                <div className="auth-header">
                    <h1><Building2 size={28} style={{display: 'inline', marginRight: '8px', verticalAlign: 'middle'}} /> Clinic Staff Registration</h1>

...
import { Eye, EyeOff, XCircle, CheckCircle, Stethoscope } from 'lucide-react';
import './Pages.css';
        ...
        <div className="auth-container">
            <div className="auth-box">
                ...
                <div className="auth-header">
                    <h1 style={{ color: '#333' }}><Stethoscope size={28} style={{display: 'inline', marginRight: '8px', verticalAlign: 'middle'}} /> Doctor Registration</h1>
                    <p style={{ color: '#666' }}>Complete your profile information</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="auth-form">
                    ...
                    <div className="form-section">
                        <h3 style={{ color: '#444' }}>PROFESSIONAL INFORMATION</h3>
                        ...
                        <div className="form-group">
                            <label style={{ color: '#333' }}>Specialization <span className="required">*</span></label>
                            <select
                                name="specialization"
                        ...
                        <div className="form-group">
                            <label style={{ color: '#333' }}>Consultation Fee (PKR) <span className="required">*</span></label>
                            <input
                                type="number"
                    ...
                    <button type="submit" className="auth-submit-btn" disabled={loading}>
                        {loading ? 'REGISTERING...' : 'COMPLETE DOCTOR REGISTRATION'}
                    </button>
                </form>
